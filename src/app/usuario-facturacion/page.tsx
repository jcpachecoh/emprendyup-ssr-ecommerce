                ...
                <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-6">
                  <div className="">
                    <div className="flex items-center mb-4 justify-between">
                      <h5 className="text-xl font-medium">Dirección de Facturación:</h5>
                      <Link href="#" className="text-fourth-base text-lg">
                  ...
                  <div className="">
                    <div className="flex items-center mb-4 justify-between">
                      <h5 className="text-xl font-medium">Dirección de Envío:</h5>
                      <Link href="#" className="text-fourth-base text-lg">
                        <FiEdit className="size-4"></FiEdit>
                      </Link>
                    </div>
