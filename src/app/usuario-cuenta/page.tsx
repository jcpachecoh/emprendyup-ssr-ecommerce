        ...
        <div className="container relative md:mt-24 mt-16">
          <div className="md:flex">
            ...
            <div className="lg:w-3/4 md:w-2/3 md:px-3 mt-6 md:mt-0">
              <h5 className="text-lg font-semibold mb-6">Mis Pedidos</h5>
                      ...
                      return (
                        <tr className="bg-white dark:bg-slate-900 text-start" key={index}>
                          ...
                          {item.status === 'Delivered' && (
                            <td className="px-2 py-3 text-start text-green-600">Entregado</td>
                          )}
                          {item.status === 'Processing' && (
                            <td className="px-2 py-3 text-start text-slate-400">En Proceso</td>
                          )}
                          {item.status === 'Canceled' && (
                            <td className="px-2 py-3 text-start text-red-600">Cancelado</td>
                          )}
                          ...
                          <td className="px-2 py-3 text-start">
                            <Link href="#" className="text-fourth-base">
                              Ver <i className="mdi mdi-chevron-right"></i>
                            </Link>
                          </td>
                        </tr>
                      );
              ...
              <h5 className="text-lg font-semibold my-6">Mis Artículos Favoritos</h5>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <div className="ms-4">
                            <Link href="" className="font-semibold hover:text-fourth-base">
                              Top de Damas
                            </Link>
