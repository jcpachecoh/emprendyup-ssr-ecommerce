    ...
    <div className="mt-2 grid grid-cols-2 gap-2">
      {options.map((option) => (
        <button
          ...
          className="px-3 py-2 bg-blue-50 hover:bg-blue-100 rounded-lg text-sm transition-colors border hover:border-blue-300"
        >
          {option}
        </button>
      ))}
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-slate-900 min-h-screen">
      <div className="bg-slate-800 rounded-3xl shadow-2xl overflow-hidden">
        ...
        {/* Chat Area */}
        <div className="h-96 overflow-y-auto p-6 space-y-4 bg-slate-800">
        ...
        {currentStep >= questions.length && (
          <div className="p-6 bg-slate-800 border-t border-slate-700">
            <div className="text-center space-y-4">
              ...
              <button
                onClick={() => console.log('Crear tienda:', storeData)}
