          ...
          <tbody>
            ...
            <tr>
              <td style={{ padding: '16px 16px 0', color: '#94a3b8', lineHeight: '24px' }}>
                This link will be active for 45 second from the time this email was sent. If you did
                not request to reset your password, please ignore this email and your account will
                not be affected.
              </td>
            </tr>
