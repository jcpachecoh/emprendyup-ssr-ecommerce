          ...
          <div className="md:flex justify-center mt-24">
            <div className="lg:w-4/5 w-full">
              <div className="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900">
                  ...
                  <div className="md:flex justify-between">
                    <div>
                      ...
                      <div className="flex mt-4">
                        ...
                        <Link
                          href="https://1.envato.market/EmprendyUp-next"
                          target="_blank"
                          className="text-fourth-base dark:text-white font-medium"
                        >
                          https://1.envato.market/EmprendyUp-next
                        </Link>
                      </div>
                    </div>
                    ...
                    <div className="mt-6 md:mt-0 md:w-56">
                      ...
                      <ul className="list-none">
                        ...
                        <li className="flex mt-3 ms-0">
                          ...
                          <Link href="mailto:contact@example.com" className="text-slate-400">
                            info@EmprendyUp.com
                          </Link>
                        </li>
                ...
                <div className="md:flex justify-between">
                  <div className="mt-6">
                    <h5 className="text-lg font-semibold">Detalles de la Factura:</h5>

                    <ul className="list-none">
                      <li className="flex mt-3 ms-0">
                        <span className="w-24">No. de Factura:</span>
                        <span className="text-slate-400">land45845621</span>
                      </li>

                      <li className="flex mt-3 ms-0">
                        <span className="w-24">Nombre:</span>
                        <span className="text-slate-400">Calvin Carlo</span>
                      </li>

                      <li className="flex mt-3 ms-0">
                        <span className="w-24">Dirección:</span>
                      ...
                      <li className="flex mt-3 ms-0">
                        ...
                        <span className="text-slate-400">(+57) 312-345-6789</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="mt-3 md:w-56">
                    <ul className="list-none">
                      <li className="flex mt-3 ms-0">
                        ...
                        <span className="text-slate-400">15 de octubre del 2021</span>
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div className="md:flex justify-between">
                    <div>
                      <div className="text-slate-400 text-center md:text-start">
                        <h6 className="mb-0">
                          Servicio al Cliente :{' '}
                          <Link href="tel:+152534-468-854" className="text-amber-500">
                            (+57) 312-345-6789
                          </Link>
                        </h6>
                      </div>
                    ...
                    <div className="mt-4 md:mt-0">
                      <div className="text-slate-400 text-center md:text-end">
                        <h6 className="mb-0">
                          <Link href="/page-terms" target="_blank" className="text-fourth-base">
