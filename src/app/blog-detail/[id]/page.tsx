          ...
          <div className="grid grid-cols-1 pb-8 text-center mt-10">
            ...
            <ul className="list-none mt-6">
              <li className="inline-block text-white/50 mx-5">
                ...
                <span className="block">Cartzio</span>
              </li>
              <li className="inline-block text-white/50 mx-5">
                {' '}
          ...
          <div className="grid md:grid-cols-12 grid-cols-1 gap-6">
            <div className="lg:col-span-8 md:col-span-6">
              <div className="relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                <Image
                  src={data?.image || '/images/blog/01.jpg'}
                  width={0}
                  height={0}
                  sizes="100vw"
                ...
                <div className="p-6">
                  <p className="text-slate-400">
                    ...
                    have originated in the 16th century. Lorem Ipsum is composed in a pseudo-Latin
                    language which more or less corresponds to &apos;proper&apos; Latin. It contains
                    a series of real Latin words. This ancient dummy text is also incomprehensible,
                    but it imitates the rhythm of most European languages in Latin script.
                  </p>
                  <p className="text-slate-400 italic border-x-4 border-orange-500 rounded-ss-xl rounded-ee-xl mt-3 p-3">
            ...
            <div className="lg:col-span-4 md:col-span-6">
              <div className="sticky top-20">
                ...
                <div className="text-center mt-8">
                  ...
                  <Link
                    href=""
                    className="text-lg font-medium hover:text-orange-500 transition-all duration-500 ease-in-out h5"
                  >
                    Cristina Romsey
                  </Link>
                  ...
                  {social.map((item, index) => {
                    ...
                    return (
                      <li className="inline" key={index}>
                        <Link
                          href=""
                          className="size-8 inline-flex items-center justify-center tracking-wide align-middle text-base border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-orange-500 hover:text-white hover:bg-orange-500"
                        >
