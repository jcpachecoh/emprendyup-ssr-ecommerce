          ...
          <tbody>
            ...
            <tr>
              <td style={{ padding: '16px 16px 0', color: '#161c2d' }}>
                ...
                <p style={{ marginBottom: '0', color: '#94a3b8' }}>
                  Thanks so much again for purchasing amazing luxurious bag. Our records show that
                  your product was delivered about a few days and we just have one question for you:
                </p>
              </td>
            </tr>
                ...
                <table>
                  <tbody>
                    <tr>
                      <td>
                        <Image
                          src="/images/shop/luxurious-bag.jpg"
                          width={200}
                          height={260}
                          style={{
                            borderRadius: '5px',
                          ...
                          alt=""
                        />
                        <p style={{ margin: '6px 0 0', fontSize: '18px', fontWeight: '500' }}>
                          Yellow Luxurious Bag
                        </p>
                      </td>
                    </tr>
                  </tbody>
            ...
            <tr>
              <td style={{ padding: '16px', color: '#94a3b8' }}>
                <label htmlFor="review" style={{ color: '#161c2d', fontWeight: '500' }}>
                  Write your rating:
                </label>
              ...
              >
                <table style={{ width: '100%' }}>
                  <tbody>
                    ...
                    <tr>
                      <td style={{ textAlign: 'center' }}>
                        <Link href="" target="_blank" style={{ color: '#ea580c' }}>
                          Unsubscribe
                        </Link>
                      </td>
                    </tr>
