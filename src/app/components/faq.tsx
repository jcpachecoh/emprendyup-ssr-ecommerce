          ...
          <div className="rounded-md shadow dark:shadow-gray-800 p-6 sticky top-20">
            <ul className="list-unstyled sidebar-nav mb-0 py-0" id="navmenu-nav">
              <li className="navbar-item p-0">
                <Link href="tech" className="text-base font-medium navbar-link">
                  Buying Questions
                </Link>
              </li>
              <li className="navbar-item mt-3 p-0 ms-0">
                <Link href="general" className="text-base font-medium navbar-link">
                  General Questions
                </Link>
              </li>
              <li className="navbar-item mt-3 p-0 ms-0">
                <Link href="payment" className="text-base font-medium navbar-link">
                  Payments Questions
                </Link>
              </li>
              <li className="navbar-item mt-3 p-0 ms-0">
                <Link href="support" className="text-base font-medium navbar-link">
                  Support Questions
                </Link>
              </li>
            </ul>
                  ...
                  >
                    <h2 className="text-base font-semibold" id="accordion-collapse-heading-1">
                      ...
                      >
                        ...
                        <FiChevronUp
                          className={`size-4 shrink-0 ${activeIndex === item.id ? '' : 'rotate-180'}`}
                        />
                      </button>
                    </h2>
                ...
                return (
                  ...
                  >
                    <h2 className="text-base font-semibold" id="accordion-collapse-heading-1">
                      <button
                        type="button"
                        className={`flex justify-between items-center p-5 w-full font-medium text-start ${item.id === activeIndex2 ? 'bg-gray-50 dark:bg-slate-800 text-fourth-base' : ''}`}
                        onClick={() => setActiveIndex2(item.id)}
                      >
                        <span>{item.title}</span>
                        <FiChevronUp
                          className={`size-4 shrink-0 ${activeIndex2 === item.id ? '' : 'rotate-180'}`}
                        />
                      </button>
                    </h2>
                ...
                return (
                  ...
                  >
                    <h2 className="text-base font-semibold" id="accordion-collapse-heading-1">
                      <button
                        type="button"
                        className={`flex justify-between items-center p-5 w-full font-medium text-start ${item.id === activeIndex4 ? 'bg-gray-50 dark:bg-slate-800 text-fourth-base' : ''}`}
                        onClick={() => setActiveIndex4(item.id)}
                      >
                        <span>{item.title}</span>
                        <FiChevronUp
                          className={`size-4 shrink-0 ${activeIndex4 === item.id ? '' : 'rotate-180'}`}
                        />
                      </button>
                    </h2>
                ...
                return (
                  ...
                  >
                    <h2 className="text-base font-semibold" id="accordion-collapse-heading-1">
                      <button
                        type="button"
                        className={`flex justify-between items-center p-5 w-full font-medium text-start ${item.id === activeIndex3 ? 'bg-gray-50 dark:bg-slate-800 text-fourth-base' : ''}`}
                        onClick={() => setActiveIndex3(item.id)}
                      >
                        <span>{item.title}</span>
                        <FiChevronUp
                          className={`size-4 shrink-0 ${activeIndex3 === item.id ? '' : 'rotate-180'}`}
                        />
                      </button>
                    </h2>
