            ...
            <tr>
              <td style={{ padding: '16px 16px 0', color: '#161c2d' }}>
                ...
                <p style={{ marginBottom: '0', color: ' #94a3b8' }}>
                  Thank you for your order success. Payment is proceed successfull and your order is
                  on the way. Please check your order via{' '}
                ...
                >
                  <thead style={{ textTransform: 'uppercase', backgroundColor: '#f8fafc' }}>
                    <tr>
                      <th
                        scope="col"
                        style={{ textAlign: 'left', padding: '10px 16px', border: 'none' }}
                      >
                        Product
                      </th>
                      <th scope="col" style={{ padding: '10px 16px', border: 'none' }}>
                        Price
                      </th>
                      <th scope="col" style={{ padding: '10px 16px', border: 'none' }}>
                        Qty
                      ...
                      <th
                        scope="col"
                        style={{ textAlign: 'right', padding: '10px 16px', border: 'none' }}
                      >
                        Total($)
                      </th>
                    </tr>
