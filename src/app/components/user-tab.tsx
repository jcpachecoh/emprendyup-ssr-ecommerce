        ...
        <div className="p-6 rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900">
          ...
          <div className="border-t border-gray-100 dark:border-gray-700">
            <ul className="list-none sidebar-nav mb-0 pb-0" id="navmenu-nav">
              <li
                className={`navbar-item account-menu ms-0 ${current === '/user-account' ? 'active' : ''}`}
              >
                <Link
                  href="/user-account"
              ...
              <li
                className={`navbar-item account-menu ms-0 ${current === '/user-billing' ? 'active' : ''}`}
              >
                <Link
                  href="/user-billing"
                  className="navbar-link text-slate-400 flex items-center py-2 rounded"
              ...
              <li
                className={`navbar-item account-menu ms-0 ${current === '/user-payment' ? 'active' : ''}`}
              >
                <Link
                  href="/user-payment"
                  className="navbar-link text-slate-400 flex items-center py-2 rounded"
              ...
              <li
                className={`navbar-item account-menu ms-0 ${current === '/user-invoice' ? 'active' : ''}`}
              >
                <Link
                  href="/user-invoice"
                  className="navbar-link text-slate-400 flex items-center py-2 rounded"
              ...
              <li
                className={`navbar-item account-menu ms-0 ${current === '/user-social' ? 'active' : ''}`}
              >
                <Link
                  href="/user-social"
                  className="navbar-link text-slate-400 flex items-center py-2 rounded"
              ...
              <li
                className={`navbar-item account-menu ms-0 ${current === '/user-notification' ? 'active' : ''}`}
              >
                <Link
              ...
              <li
                className={`navbar-item account-menu ms-0 ${current === '/user-setting' ? 'active' : ''}`}
              >
                <Link
                  href="/user-setting"
                  className="navbar-link text-slate-400 flex items-center py-2 rounded"
              ...
              <li
                className={`navbar-item account-menu ms-0 ${current === '/lock-screen' ? 'active' : ''}`}
              >
                <Link
                  href="/lock-screen"
                  className="navbar-link text-slate-400 flex items-center py-2 rounded"
