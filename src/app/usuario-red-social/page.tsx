            ...
            <div className="lg:w-3/4 md:w-2/3 md:px-3 mt-6 md:mt-0">
              <div className="rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-6">
                <div className="p-6 border-b border-gray-100 dark:border-gray-700">
                  <h5 className="text-lg font-semibold">Perfil Social :</h5>
                </div>
                ...
                <div className="p-6">
                        ...
                        <div className="md:w-2/3 mt-4 md:mt-0">
                          <form>
                            <div className="form-icon relative">
                              <Icon className="w-4 h-4 absolute top-3 start-4" />
                              <input
                                type="text"
                  ...
                  <div className="md:flex">
                    <div className="md:w-1/3">
                      ...
                      <button className="py-2 px-2 inline-block font-semibold tracking-wide align-middle duration-500 text-base text-center bg-fourth-base text-black rounded-md mt-5">
                        Guardar Cambios
                      </button>
                    </div>
                  </div>
