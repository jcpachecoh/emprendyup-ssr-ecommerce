...
export default function Sale() {
  return (
    <>
          ...
          <div className="grid grid-cols-1">
            <div className="text-center">
              <h6 className="text-slate-900 dark:text-white font-semibold">
                Refiere a un amigo y gana $25.000 en créditos 🎉
              </h6>
            </div>
          </div>
        </div>
      ...
      <section className="relative table w-full items-center pt-36 pb-52 bg-secondary-500 bg-[url('/images/hero/bg-shape.png')] bg-center bg-no-repeat bg-cover">
        <div className="container relative">
          <div className="grid grid-cols-1 text-center mt-10">
            <h3 className="md:text-7xl text-5xl md:leading-normal leading-normal tracking-wide font-bold uppercase text-white">
              DESCUENTOS <br /> Hasta 75% OFF
            </h3>
            <div className="mt-6">
              <Link
                href=""
      ...
      <section className="relative md:py-24 py-16">
                ...
                {salesData.map((item, index) => {
                  return (
                    <div
                      ...
                      key={index}
                    >
                      <div className="p-6 bg-secondary-base">
                        <span className="bg-white text-black font-bold px-2.5 py-0.5 rounded-full h-5">
                          {item.tag}
                        </span>
                      ...
                      <div className="p-6 bg-white dark:bg-slate-900">
                        <p className="text-sm font-medium uppercase">Usar código</p>
        ...
        <div className="container relative md:mt-24 mt-16">
          <div className="grid grid-cols-1 justify-center text-center mb-6">
            <h5 className="font-semibold text-3xl leading-normal mb-4">Ofertas destacadas</h5>
            <p className="text-slate-400 max-w-xl mx-auto">
              Compra los últimos productos de las colecciones más populares
            </p>
          </div>
                    ...
                    <ul className="list-none absolute top-[10px] start-4">
                      {item.offer === true && (
                        <li>
                          <Link
                            href="#"
                            className="bg-secondary-500 text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5"
                          >
                            {item.tag}
                          </Link>
                        </li>
