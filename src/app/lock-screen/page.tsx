              ...
              <form>
                <div className="grid grid-cols-1">
                  ...
                  <div className="">
                    <input
                      type="submit"
                      className="py-2 px-5 inline-block tracking-wide border align-middle duration-500 text-base text-center bg-orange-500 hover:bg-orange-600 border-orange-500 hover:border-orange-600 text-white rounded-md w-full"
                      value="Login / Sign in"
                    />
                  </div>
                </div>
