      ...
      <section className="relative table w-full py-20 lg:py-24 bg-gray-50 dark:bg-slate-800">
        <div className="container relative">
          <div className="grid grid-cols-1 text-center mt-14">
            <h3 className="text-3xl leading-normal font-semibold">Compara Productos</h3>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1">
            <div className="rounded p-6 shadow dark:shadow-gray-800">
              <p className="text-slate-400">
                No se han añadido productos a la página de comparación.{' '}
                <Link href="/shop-grid" className="font-medium text-fourth-base">
                  Volver a comprar
                </Link>
              </p>
            </div>
