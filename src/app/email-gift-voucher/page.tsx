            ...
            >
              <th scope="col" style={{ margin: 'auto', display: 'block' }}>
                <Link href="/" style={{ display: 'flex', justifyContent: 'center' }}>
                  <Image src="/images/logo-icon-64.png" alt="" width={64} height={64} />
                </Link>
              </th>
            </tr>
          </thead>
            ...
            <tr>
              <td style={{ padding: '16px 16px 0', color: '#161c2d' }}>
                ...
                <p style={{ marginBottom: '0', color: '#94a3b8' }}>
                  Please check your gift voucher is now available.
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style={{ padding: '16px 16px 0' }}>
                ...
                >
                  ...
                  <span style={{ display: 'block', color: '#94a3b8', marginTop: '16px' }}>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsam nihil illum
                    dolorum, quis nobis, ducimus magnam veniam.
                  </span>
                </span>
              </td>
            </tr>
