          ...
          <div className="grid grid-cols-1 pb-8 text-center mt-10">
            ...
            <ul className="list-none mt-6">
              <li className="inline-block text-white/50 mx-5">
                ...
                <span className="block">EmprendyUp</span>
              </li>
              <li className="inline-block text-white/50 mx-5">
                {' '}
            ...
            <div className="lg:col-span-8 md:col-span-6">
              <div className="relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                ...
                <div className="p-6">
                  ...
                  <p className="text-slate-400 italic border-x-4 border-fourth-base rounded-ss-xl rounded-ee-xl mt-3 p-3">
                  ...
                  {social.map((item, index) => {
                    ...
                    return (
                      <li className="inline" key={index}>
                        <Link
                          href=""
                          className="size-8 inline-flex items-center justify-center tracking-wide align-middle text-base border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-fourth-base hover:text-white hover:bg-fourth-base"
                        >
